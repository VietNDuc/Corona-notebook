...
DIR = "/Users/vietnd/Documents/GitHub/Corona-notebook/dataset/novel_covid19_kaggle/"
...
class Learner(object):
    ...
    def load_confirmed(self, country):
        df = pd.read_csv(DIR+'/time_series_covid_19_confirmed_country.csv')
        country_df = df[df['Country/Region'] == country]
        return country_df.iloc[0].loc[self.start_date:]

    def load_recovered(self, country):
        df = pd.read_csv(DIR+'/time_series_covid_19_recovered_country.csv')
        country_df = df[df['Country/Region'] == country]
        return country_df.iloc[0].loc[self.start_date:]

    def load_dead(self, country):
        df = pd.read_csv(DIR+'/time_series_covid_19_deaths_country.csv')
        country_df = df[df['Country/Region'] == country]
        return country_df.iloc[0].loc[self.start_date:]
...
def main():
    ...
    sumCases_province(DIR+'/time_series_covid_19_confirmed.csv', DIR+'/time_series_covid_19_confirmed_country.csv')
    sumCases_province(DIR+'/time_series_covid_19_recovered.csv', DIR+'/time_series_covid_19_recovered_country.csv')
    sumCases_province(DIR+'/time_series_covid_19_deaths.csv', DIR+'/time_series_covid_19_deaths_country.csv')
